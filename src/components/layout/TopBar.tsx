...
import { Save, Share2, LogIn } from "lucide-react";
    ...
    <header className="relative z-20 flex h-14 items-center justify-between border-b border-border bg-surface px-4">
      ...
      <div className="flex items-center gap-2">
        ...
        {user ? (
          ...
          <Link
            href="/auth/login"
            className="inline-flex h-9 items-center gap-2 rounded-chip border border-border bg-surface px-3 text-sm font-medium text-fg hover:bg-surface-2 transition-colors"
          >
